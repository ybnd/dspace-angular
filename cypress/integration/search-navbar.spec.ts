...
const page = {
    fillOutQueryInNavBar(query) {
        ...
        cy.get('ds-navbar [data-test="header-search-icon"]').click();
        // Fill out a query in input that appears
        cy.get('ds-navbar [data-test="header-search-box"]').type(query);
    },
    submitQueryByPressingEnter() {
        cy.get('ds-navbar [data-test="header-search-box"]').type('{enter}');
    },
