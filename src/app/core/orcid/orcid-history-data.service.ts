...
export class OrcidHistoryDataService {
  ...
  constructor(
    ...
    this.dataService = new OrcidHistoryServiceImpl(
      requestService,
      rdbService,
      store,
      objectCache,
  ...
  findById(
    ...
    ...linksToFollow: FollowLinkConfig<OrcidHistory>[]
  ): Observable<RemoteData<OrcidHistory>> {
  ...
  findAllByHref(
    ...
    reRequestOnStale = true,
    ...linksToFollow: FollowLinkConfig<OrcidHistory>[]
  ): Observable<RemoteData<PaginatedList<OrcidHistory>>> {
