...
describe('ResearcherProfileService', () => {
  ...
  beforeEach(() => {
    ...
    spyOn((service as any).dataService, 'getLinkPath').and.returnValue(
  ...
  describe('setVisibility', () => {
    ...
    beforeEach(() => {
      ...
      spyOn(service as any, 'findById').and.returnValue(
        createSuccessfulRemoteDataObject$(researcherProfilePatched)
      );
    });
    ...
    it('should proxy the call to dataservice.patch', () => {
      ...
      expect((service as any).dataService.patch).toHaveBeenCalledWith(
        researcherProfile,
        [replaceOperation]
      );
    });
  ...
  describe('updateByOrcidOperations', () => {
    ...
    it('should call patch method properly', () => {
      scheduler.schedule(() =>
        service.updateByOrcidOperations(researcherProfile, []).subscribe()
      );
      scheduler.flush();
