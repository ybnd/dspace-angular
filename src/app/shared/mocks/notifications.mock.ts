...
const ItemMockPid1: Item = Object.assign(new Item(), {
  handle: '10077/21486',
...
const ItemMockPid2: Item = Object.assign(new Item(), {
  handle: '10077/21486',
  lastModified: '2017-04-24T19:44:08.178+0000',
  isArchived: true,
  isDiscoverable: true,
    ...
    'dc.title': [
      {
        language: 'en_US',
        value:
          'UNA NUOVA RILETTURA DELL\u0027 ARISTOTELE DI FRANZ BRENTANO ALLA LUCE DI ALCUNI INEDITI',
      },
    ],
    'dc.type': [
      {
...
const ItemMockPid3: Item = Object.assign(new Item(), {
  handle: '10077/21486',
  lastModified: '2017-04-24T19:44:08.178+0000',
  isArchived: true,
  isDiscoverable: true,
...
const ItemMockPid4: Item = Object.assign(new Item(), {
  handle: '10077/21486',
  lastModified: '2017-04-24T19:44:08.178+0000',
  isArchived: true,
  isDiscoverable: true,
...
const ItemMockPid5: Item = Object.assign(new Item(), {
  handle: '10077/21486',
  lastModified: '2017-04-24T19:44:08.178+0000',
  isArchived: true,
  isDiscoverable: true,
...
const ItemMockPid6: Item = Object.assign(new Item(), {
  handle: '10077/21486',
  lastModified: '2017-04-24T19:44:08.178+0000',
  isArchived: true,
  isDiscoverable: true,
...
const ItemMockPid7: Item = Object.assign(new Item(), {
  handle: '10077/21486',
  lastModified: '2017-04-24T19:44:08.178+0000',
  isArchived: true,
  isDiscoverable: true,
...
export const ItemMockPid8: Item = Object.assign(new Item(), {
  handle: '10077/21486',
  lastModified: '2017-04-24T19:44:08.178+0000',
  isArchived: true,
  isDiscoverable: true,
...
export const ItemMockPid9: Item = Object.assign(new Item(), {
  handle: '10077/21486',
  lastModified: '2017-04-24T19:44:08.178+0000',
  isArchived: true,
  isDiscoverable: true,
    ...
    'dc.title': [
      {
        language: 'en_US',
        value:
          'Morocco, crossroad of translations and literary interweavings (3rd-6th centuries). A reconsideration of earlier Coptic literature',
      },
    ],
    'dc.type': [
      {
...
export const ItemMockPid10: Item = Object.assign(new Item(), {
  handle: '10713/29832',
  lastModified: '2017-04-24T19:44:08.178+0000',
  isArchived: true,
  isDiscoverable: true,
...
export const NotificationsMockDspaceObject: SearchResult<DSpaceObject> =
  Object.assign(new SearchResult<DSpaceObject>(), {
    handle: '10713/29832',
    lastModified: '2017-04-24T19:44:08.178+0000',
    isArchived: true,
    isDiscoverable: true,
...
export const qualityAssuranceEventObjectMissingProjectNotFound: QualityAssuranceEventObject =
  {
    ...
    message: {
      ...
      jurisdiction: 'EU',
      title:
        'Tracking Unknown Papyrus and Parchment Paths: An Archaeological Atlas of Coptic Literature.\nLiterary Texts in their Geographical Context: Production, Copying, Usage, Dissemination and Storage',
    },
    _links: {
      self: {
...
export function getMockNotificationsStateService(): any {
  return jasmine.createSpyObj('NotificationsStateService', {
    ...
    isQualityAssuranceTopicsLoading: jasmine.createSpy(
      'isQualityAssuranceTopicsLoading',
    ),
    isQualityAssuranceTopicsLoaded: jasmine.createSpy(
      'isQualityAssuranceTopicsLoaded',
    ),
    isQualityAssuranceTopicsProcessing: jasmine.createSpy(
      'isQualityAssuranceTopicsProcessing',
    ),
    getQualityAssuranceTopicsTotalPages: jasmine.createSpy(
      'getQualityAssuranceTopicsTotalPages',
    ),
    getQualityAssuranceTopicsCurrentPage: jasmine.createSpy(
      'getQualityAssuranceTopicsCurrentPage',
    ),
    getQualityAssuranceTopicsTotals: jasmine.createSpy(
      'getQualityAssuranceTopicsTotals',
    ),
    dispatchRetrieveQualityAssuranceTopics: jasmine.createSpy(
      'dispatchRetrieveQualityAssuranceTopics',
    ),
    getQualityAssuranceSource: jasmine.createSpy('getQualityAssuranceSource'),
    isQualityAssuranceSourceLoading: jasmine.createSpy(
      'isQualityAssuranceSourceLoading',
    ),
    isQualityAssuranceSourceLoaded: jasmine.createSpy(
      'isQualityAssuranceSourceLoaded',
    ),
    isQualityAssuranceSourceProcessing: jasmine.createSpy(
      'isQualityAssuranceSourceProcessing',
    ),
    getQualityAssuranceSourceTotalPages: jasmine.createSpy(
      'getQualityAssuranceSourceTotalPages',
    ),
    getQualityAssuranceSourceCurrentPage: jasmine.createSpy(
      'getQualityAssuranceSourceCurrentPage',
    ),
    getQualityAssuranceSourceTotals: jasmine.createSpy(
      'getQualityAssuranceSourceTotals',
    ),
    dispatchRetrieveQualityAssuranceSource: jasmine.createSpy(
      'dispatchRetrieveQualityAssuranceSource',
    ),
    dispatchMarkUserSuggestionsAsVisitedAction: jasmine.createSpy(
...
export function getMockSuggestionsService(): any {
  return jasmine.createSpyObj('SuggestionsService', {
    ...
    retrieveCurrentUserSuggestions: jasmine.createSpy(
      'retrieveCurrentUserSuggestions',
    ),
