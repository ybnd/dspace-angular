...
describe('LinkMenuItemComponent', () => {
  ...
  beforeEach(waitForAsync(() => {
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {
          provide: 'itemModelProvider',
          useValue: { text: text, link: link, queryParams: queryParams },
        },
  ...
  it('should have the right queryParams attribute', () => {
    const queryDes = fixture.debugElement.queryAll(
      By.directive(QueryParamsDirectiveStub)
    );
    const routerParamsQuery = queryDes.map((de) =>
