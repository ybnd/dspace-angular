...
describe('PersonPageClaimButtonComponent', () => {
  ...
  const researcherProfileService = jasmine.createSpyObj(
    ...
    describe('claim', () => {
      describe('when successfully', () => {
        beforeEach(() => {
          ...
          researcherProfileService.createFromExternalSource.and.returnValue(
            createSuccessfulRemoteDataObject$(mockResearcherProfile)
          );
          researcherProfileService.findRelatedItemId.and.returnValue(
      ...
      describe('when not successfully', () => {
        ...
        it('should display success notification', () => {
          ...
          expect(
            researcherProfileService.findRelatedItemId
  ...
  describe('when item cannot be claimed', () => {
    beforeEach(() => {
      authorizationDataService.isAuthorized.and.returnValue(
        observableOf(false)
      );
      fixture.detectChanges();
    });
