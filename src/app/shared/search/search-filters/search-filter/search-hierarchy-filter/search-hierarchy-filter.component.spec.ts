...
describe('SearchHierarchyFilterComponent', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [SearchHierarchyFilterComponent],
      providers: [
        ...
        { provide: IN_PLACE_SEARCH, useValue: false },
        {
          ...
          useValue: Object.assign(new SearchFilterConfig(), {
  ...
  function init() {
    ...
    showVocabularyTreeLink = fixture.debugElement.query(
      By.css('a#show-test-search-filter-tree'),
    );
  }
    ...
    describe('when clicking the vocabulary tree link', () => {
      ...
      beforeEach(async () => {
        ...
        fixture.componentInstance.selectedValues$ = observableOf(
          alreadySelectedValues.map((value) =>
            Object.assign(new FacetValue(), { value }),
          ),
        );
        VocabularyTreeViewComponent.select.emit(
          Object.assign(new VocabularyEntryDetail(), {
