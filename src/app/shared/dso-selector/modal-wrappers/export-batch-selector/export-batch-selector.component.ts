...
export class ExportBatchSelectorComponent
  ...
  implements OnInit
{
  ...
  navigate(dso: DSpaceObject): Observable<boolean> {
    if (dso instanceof Collection) {
      ...
      modalRef.componentInstance.headerLabel =
        'confirmation-modal.export-batch.header';
      modalRef.componentInstance.infoLabel =
        'confirmation-modal.export-batch.info';
      modalRef.componentInstance.cancelLabel =
        'confirmation-modal.export-batch.cancel';
      modalRef.componentInstance.confirmLabel =
        'confirmation-modal.export-batch.confirm';
  ...
  private startScriptNotifyAndRedirect(dso: DSpaceObject): Observable<boolean> {
    ...
    return this.authorizationDataService
      .isAuthorized(FeatureID.AdministratorOf)
      .pipe(
        switchMap(() => {
          return this.scriptDataService.invoke(
            BATCH_EXPORT_SCRIPT_NAME,
            parameterValues,
            [],
          );
