...
export const rotateInState = state(
  'rotateIn',
...
export const rotateOutState = state(
  'rotateOut',
  style({ opacity: 0, transform: 'rotate(5deg)' }),
);
...
export const rotateIn = trigger('rotateIn', [rotateEnter]);

export const rotateOut = trigger('rotateOut', [rotateLeave]);

export const rotateInOut = trigger('rotateInOut', [rotateEnter, rotateLeave]);
