...
export const slideSidebar = trigger('slideSidebar', [
  transition(
    ...
    group([
      ...
      query(
        '.sidebar-collapsible',
        animate('300ms ease-in-out', collapsedStyle)
      ),
    ])
  ),
  ...
  transition(
    ...
    group([
      ...
      query(
        '.sidebar-collapsible',
        animate('300ms ease-in-out', expandedStyle),
        options
      ),
    ])
  ),
...
export const slideSidebarPadding = trigger('slideSidebarPadding', [
  ...
  state('shown', style({ paddingLeft: '{{ collapsedSidebarWidth }}' }), {
    params: { collapsedSidebarWidth: '*' },
  }),
  state('expanded', style({ paddingLeft: '{{ totalSidebarWidth }}' }), {
    params: { totalSidebarWidth: '*' },
  }),
