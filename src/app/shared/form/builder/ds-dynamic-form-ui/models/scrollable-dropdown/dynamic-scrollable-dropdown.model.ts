...
export const DYNAMIC_FORM_CONTROL_TYPE_SCROLLABLE_DROPDOWN =
  'SCROLLABLE_DROPDOWN';

export interface DynamicScrollableDropdownModelConfig
...
export class DynamicScrollableDropdownModel extends DsDynamicInputModel {
  ...
  constructor(
    config: DynamicScrollableDropdownModelConfig,
