...
export class FormBuilderService extends DynamicFormService {
  ...
  createDynamicFormControlEvent(
    ...
    const context: DynamicFormArrayGroupModel =
      model?.parent instanceof DynamicFormArrayGroupModel
        ? model?.parent
        : null;
    return {
      $event,
  ...
  setTypeBindFieldFromConfig(): void {
    this.configService
      .findByPropertyName('submit.type-bind.field')
