 ...
 */
export const REGEX_FIELD_VALIDATOR = new RegExp(
  '(\\/?)(.+)\\1([gimsuy]*)',
  'i',
);
...
export abstract class FieldParser {
  ...
  protected initModel(
    ...
    controlModel.readOnly =
      this.parserOptions.readOnly ||
      this.isFieldReadOnly(
        this.configData.visibility,
        this.configData.scope,
        this.parserOptions.submissionScope,
      );
  ...
  protected addPatternValidator(controlModel) {
    const validatorMatcher = this.configData.input.regex.match(
